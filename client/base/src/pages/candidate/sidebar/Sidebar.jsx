...
export default function Sidebar() {
  ...
  return (
      ...
      <div className='flex font-[inter] border-t'>
        <div className="flex h-[100vh] card-shadow-lite2 border-r">
          <aside className={`bg-[white] relative transition-all duration-500 ${showText ? 'w-[230px]' : 'w-20'} space-y-4 px-2 flex flex-col`}>
            <button id='bump' onClick={toggleText} className="border-x border-t rotate-90 flex items-center justify-center bg-white z-[100]">
            ...
            <div onClick={()=>setSelectedCandidateMenu("profile")} className={`flex items-center px-4 py-2 ${selectedCandidateMenu=="profile"?"text-[#004AAD] font-[500]":"text-[#A6ABBF]"}   hover:bg-gray-100 rounded`}>
            ...
            <a href="#messages" onClick={()=>setSelectedCandidateMenu("messages")} className={`flex items-center px-4 py-2 ${selectedCandidateMenu=="messages"?"text-[#004AAD] font-[500]":"text-[#A6ABBF]"}   hover:bg-gray-100 rounded`}>
            ...
            <a href="#bookings" onClick={()=>setSelectedCandidateMenu("bookings")} className={`flex items-center px-4 py-2 ${selectedCandidateMenu=="bookings"?"text-[#004AAD] font-[500]":"text-[#A6ABBF]"}   hover:bg-gray-100 rounded`}>
            ...
            <a href="#mytasks" onClick={()=>setSelectedCandidateMenu("mytasks")} className={`flex items-center px-4 py-2 ${selectedCandidateMenu=="mytasks"?"text-[#004AAD] font-[500]":"text-[#A6ABBF]"}   hover:bg-gray-100 rounded`}>
            ...
            <a href="#todos" onClick={()=>setSelectedCandidateMenu("todos")} className={` flex items-center px-4 py-2 ${selectedCandidateMenu=="todos"?"text-[#004AAD] font-[500]":"text-[#A6ABBF]"}   hover:bg-gray-100 rounded`}>
        ...
        <div className='flex flex-1 bg-[green] h-screen w-[80%] relative'>
        <Content/>
