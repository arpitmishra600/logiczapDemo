      ...
      <div className='flex font-[inter] border-t'>
        <div className="flex card-shadow-lite2 border-r pt-14  max-md:hidden">
          <aside className={`bg-[white] relative transition-all duration-500 ${showText ? 'w-[230px]' : 'w-20'} space-y-4 px-2 flex flex-col`}>
            <button onClick={toggleText} className="absolute rounded-full bg-ourBlue -right-4 top-5 rotate-90  flex items-center justify-center z-[100]">
            ...
            <button disabled onClick={()=>setSelectedCandidateMenu("profile")} className={`flex items-center px-4 py-2 ${selectedCandidateMenu=="profile"?"text-[#004AAD] font-[500]":"text-[#A6ABBF]"}   hover:bg-gray-100 rounded cursor-pointer`}>
            ...
            <button disabled onClick={()=>setSelectedCandidateMenu("messages")} className={`flex items-center px-4 py-2 ${selectedCandidateMenu=="messages"?"text-[#004AAD] font-[500]":"text-[#A6ABBF]"}   hover:bg-gray-100 rounded cursor-not-allowed`}>
            ...
            <button disabled onClick={()=>setSelectedCandidateMenu("mytasks")} className={`flex items-center px-4 py-2 ${selectedCandidateMenu=="mytasks"?"text-[#004AAD] font-[500]":"text-[#A6ABBF]"}   hover:bg-gray-100 rounded cursor-not-allowed`}>
            ...
            <button disabled onClick={()=>setSelectedCandidateMenu("todos")} className={` flex items-center px-4 py-2 ${selectedCandidateMenu=="todos"?"text-[#004AAD] font-[500]":"text-[#A6ABBF]"}   hover:bg-gray-100 rounded cursor-not-allowed`}>
