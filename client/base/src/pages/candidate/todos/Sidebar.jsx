...
import boardIcon from "/todos/icon-board.svg";
import useDarkMode from "../../../hooks/useDarkMode";
import darkIcon from "/todos/icon-dark-theme.svg";
import lightIcon from "/todos/icon-light-theme.svg";

import showSidebarIcon from "/todos/icon-show-sidebar.svg";
import hideSidebarIcon from "/todos/icon-hide-sidebar.svg";
  ...
  return (
    <div>
      <div
        className={
          isSideBarOpen
            ? `min-w-[261px] bg-white dark:bg-[#2b2c37] absolute top-[72px] h-screen  items-center left-0 z-20 border-r`
