...
export default function BlackButton({title,changes,arrow}) {
  ...
  return (
    <>
        <motion.button  whileTap={{ scale: 0.85 }} className={`flex justify-center items-center relative border text-sm inter font-bold text-[white] px-4 py-2 border-1 border-habotOrange flex-1 rounded-lg bg-black transition duration-300 ease-out max-sm:text-xs text-nowrap ${changes}`}>
