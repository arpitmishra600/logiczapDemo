      ...
      <div className='flex font-[inter] h-full gap-10'>
        <div className="flex rounded-xl max-md:hidden">
          <aside className={`rounded-[32px] bg-[white] relative transition-all duration-500 ${showText ? 'w-[230px]' : 'w-20'} space-y-4 px-2 flex flex-col`}>
            ...
            <button onClick={()=>setSelectedRecruiterMenu("profile")} className={`flex items-center px-4 py-2 ${selectedRecruiterMenu=="profile"?"text-[#004AAD] font-[500]":"text-[#A6ABBF]"}   hover:bg-gray-100 rounded `}>
            ...
            <button disabled onClick={()=>setSelectedRecruiterMenu("messages")} className={`flex items-center px-4 py-2 ${selectedRecruiterMenu=="messages"?"text-[#004AAD] font-[500]":"text-[#A6ABBF]"}   hover:bg-gray-100 rounded cursor-not-allowed`}>
            ...
            <button onClick={()=>setSelectedRecruiterMenu("candidates")} className={`flex items-center px-4 py-2 ${selectedRecruiterMenu=="candidates"?"text-[#004AAD] font-[500]":"text-[#A6ABBF]"}   hover:bg-gray-100 rounded`}>
            ...
            <button disabled onClick={()=>setSelectedRecruiterMenu("mytasks")} className={`flex items-center px-4 py-2 ${selectedRecruiterMenu=="mytasks"?"text-[#004AAD] font-[500]":"text-[#A6ABBF]"}   hover:bg-gray-100 rounded cursor-not-allowed`}>
            ...
            <button disabled onClick={()=>setSelectedRecruiterMenu("todos")} className={` flex items-center px-4 py-2 ${selectedRecruiterMenu=="todos"?"text-[#004AAD] font-[500]":"text-[#A6ABBF]"}   hover:bg-gray-100 rounded cursor-not-allowed`}>
            ...
            <button disabled className={`flex absolute bottom-5 items-center px-4 py-2 text-[#A6ABBF]  hover:bg-gray-100 rounded cursor-not-allowed`}>
