...
const {signupHandler, loginHandler, logoutHandler, sendOtpHandler, getFullUser, updateProfileImage, updateCoverImage, getAllUsers, getLastSeen, search} = require("../controllers/user.controllers");
